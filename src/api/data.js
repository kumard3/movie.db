...
const requests = {
    ...
    fetchPage5: `https://api.themoviedb.org/3/keyword/210024/movies?api_key=${process.env.REACT_APP_TMDB_API_KEY}&page=5`,
    fetchPage6: `https://api.themoviedb.org/3/keyword/210024/movies?api_key=${process.env.REACT_APP_TMDB_API_KEY}&page=6`,
    fetchPage7: `https://api.themoviedb.org/3/keyword/210024/movies?api_key=${process.env.REACT_APP_TMDB_API_KEY}&page=7`,
};
